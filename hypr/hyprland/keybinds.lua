...
hl.bind(
	"SUPER + CTRL + S",
	hl.dsp.window.move(
		{ workspace = "special:special", follow = false, description = "Send to scratchpad" },
		{ description = "Send to scratchpad" }
	)
)
hl.bind("SUPER + ALT + S", hl.dsp.window.move({ workspace = 1, follow = true, description = "Return from scratchpad" }))
